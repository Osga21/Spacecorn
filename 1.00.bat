...
echo Sites
echo 1)Sourceforge
echo 2)GoogleProjects
echo Input choice:
set/p input=        
if "%input%"=="sourceforge" start https://sourceforge.net/projects/spacecorn/
if "%input%"=="googleprojects" start http://code.google.com/p/spacecorn/
if "%input%"=="1" start https://sourceforge.net/projects/spacecorn/
if "%input%"=="2" start http://code.google.com/p/spacecorn/
if "%input%"=="Sourceforge" start https://sourceforge.net/projects/spacecorn/
if "%input%"=="Googleprojects" start http://code.google.com/p/spacecorn/
) else (
...
echo  --------------------LEVEL 1--------------------------
echo You wake up in strange planet, your voyage was a success.
echo Your horn is damaged, you encounter yourself surrounded
echo by barbed wire, guarding a house.
...
echo the carpet does matches the drapes you think
...
--------------------wallclose1----------------------------
:wallclose1:
echo As you approach the wall, you read "I want to play a game...I like gaems!!1"
echo apparently a key drops for no reason, what to do, what to do?
...
echo your ass, a doorway seems to open, strange huh?
echo What will you do?
set/p input= (go inside/go back/use pokeball)
if "%input%"=="go inside" goto dg1
if "%input%"=="go back" goto wc1
...
---------------------pokeball----------------------------
:pokeball:
echo this ain't no pokaymon game muthafucka
goto upyoass
...
echo Congratulations! You finnished the level!
...
---------------------tv1----------------------------
:tv1:
echo OOOhoohoUUhu! A porno is on.
...
---------------------porno1----------------------------
:porno1:
echo EEhhueHUHheee! That was some transexual porn!
echo You throw up so hard your stomach is expeled.
...
---------------------office1----------------------------
:office1:
echo What a wierd office? There are 2 pink dildos on a desk
...
echo keep going, also the goblins drop a gem
echo that opens a door
...
set/p input=  "But after all you find an exit (continue/quit)"
if "%input%"=="continue" goto lvl3
if "%input%"=="Continue" goto lvl3
if "%input%"=="quit" goto quit
if "%input%"=="Quit" goto quit
...
echo        ^|           Be sure to check our website for future          ^|
echo        ^|    updates, news, and the continuation of this epic saga!  ^|
echo        ^|                       Bronies Unite!                       ^|
echo        ^|     Don't forget to check our website : Not available yet                   
echo          ------------------------------------------------------------
...
if "%input%"=="yes" goto aquit
if "%input%"=="no" goto start
if "%input%"=="Yes" goto aquit
if "%input%"=="No" goto start
if "%input%"=="y" goto aquit
